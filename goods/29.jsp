...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_simpOcase光雕保護殼- 巴黎異想 </title>
	<!-- demo only -->
...
%>
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/29.jpg" alt="smallsimpOcase光雕保護殼- 巴黎異想 ">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/29.jpg" alt="bigsimpOcase光雕保護殼- 巴黎異想 ">
		</div>
		...
		<h1 class="product_entry-title_name">simpOcase光雕保護殼- 巴黎異想 </h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I6.simpOcase光雕保護殼- 巴黎異想" >
