...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_UP2度c 紳士法鬥</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/30.jpg" alt="smallUP2度c 紳士法鬥">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/30.jpg" alt="bigUP2度c 紳士法鬥">
		</div>
		...
		<h1 class="product_entry-title_name">UP2度c 紳士法鬥</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I6.6splus_UP2度c 紳士法鬥" >
	 ...
	 <div class="product-details_information">
	 	...
	 	<fieldset>
	 		<legend>商品介紹</legend>
	 		❶專為iPhone 6+/6s+量身打造 密合度高<br>
	 		❷採用歐盟認證環保材質與UV墨水製作<br>
	 		❸機殼材質屬TPU透明軟殼，美觀層次多變<br>
	 		❹軟殼設計，完美包覆，更防摔。
	 	</fieldset>
