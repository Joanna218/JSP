...
<head>
	<meta charset="UTF-8">
	<title>I7.8_BYEBYECHUCHU 掰掰啾啾-奧樂雞 WaKase </title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/43.jpg" alt="smallBYEBYECHUCHU 掰掰啾啾-奧樂雞 WaKase ">
	  </div>

		<div class="large">
			<img src="../image/i7.8/43.jpg" alt="bigBYEBYECHUCHU 掰掰啾啾-奧樂雞 WaKase ">
		</div>
		...
		<h1 class="product_entry-title_name">BYEBYECHUCHU 掰掰啾啾-奧樂雞 WaKase </h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data'  action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_BYEBYECHUCHU 掰掰啾啾-奧樂雞 WaKase" >
