...
<head>
	<meta charset="UTF-8">
	<title>IX_Mokka 時尚木紋 插卡 手機殼 </title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/85.jpg" alt="smallMokka 時尚木紋 插卡 手機殼 ">
	  </div>

		<div class="large">
			<img src="../image/iX/85.jpg" alt="bigMokka 時尚木紋 插卡 手機殼 ">
		</div>
		...
		<h1 class="product_entry-title_name">Mokka 時尚木紋 插卡 手機殼 </h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_Mokka 時尚木紋 插卡 手機殼" >
