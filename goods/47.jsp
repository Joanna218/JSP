...
<head>
	<meta charset="UTF-8">
	<title>I7.8_ONUSK Cattitude 手機保護殼-藍</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/47.jpg" alt="smallONUSK Cattitude 手機保護殼-藍">
	  </div>

		<div class="large">
			<img src="../image/i7.8/47.jpg" alt="bigONUSK Cattitude 手機保護殼-藍">
		</div>
		...
		<h1 class="product_entry-title_name">ONUSK Cattitude 手機保護殼-藍</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_ONUSK Cattitude 手機保護殼-藍" >
