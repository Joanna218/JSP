...
<head>
	<meta charset="UTF-8">
	<title>IX_SEIDIO DILE 軍規級四角防撞保護殼</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/87.jpg" alt="smallSEIDIO DILE 軍規級四角防撞保護殼 ">
	  </div>

		<div class="large">
			<img src="../image/iX/87.jpg" alt="bigSEIDIO DILE 軍規級四角防撞保護殼 ">
		</div>
		...
		<h1 class="product_entry-title_name">SEIDIO DILE 軍規級四角防撞保護殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="IX_SEIDIO DILE 軍規級四角防撞保護殼" >
