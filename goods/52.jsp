...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/52.jpg" alt="small紅點法鬥 手機殼">
	  </div>

		<div class="large">
			<img src="../image/i7.8/52.jpg" alt="big紅點法鬥 手機殼">
		</div>
		...
		<h1 class="product_entry-title_name">紅點法鬥 手機殼</h1><p class="price">
		</div></p>
	...
	紅點法鬥 手機殼
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_紅點法鬥 手機殼" >
