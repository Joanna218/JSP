...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_迪士尼 米奇屁屁 背影系列 硬殼 </title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/35.jpg" alt="small迪士尼 米奇屁屁 背影系列 硬殼 ">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/35.jpg" alt="big迪士尼 米奇屁屁 背影系列 硬殼">
		</div>
		...
		<h1 class="product_entry-title_name">迪士尼 米奇屁屁 背影系列 硬殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data'  action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_迪士尼 米奇屁屁 背影系列 硬殼" >
