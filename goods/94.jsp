...
<head>
	<meta charset="UTF-8">
	<title>IX_美國 Case Naked Tough 雙層防摔手機保護殼 - 絢麗彩虹</title>
	<!-- demo only -->
...
<body>
	...
	<!--index-->
		...
		<span class="menu">
			<ul class="drop-down-menu">
        		...
        		<li><a href="../member.jsp">會員中心</a>
       			...
       			<li><a href="../shopping cart.jsp">購物車</a>
   	    		</li> 
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/94.jpg" alt="small美國 Case Naked Tough 雙層防摔手機保護殼 - 絢麗彩虹
			  ">
	  </div>

		<div class="large">
			<img src="../image/iX/94.jpg" alt="big美國 Case Naked Tough 雙層防摔手機保護殼 - 絢麗彩虹
			">
		</div>
		...
		<h1 class="product_entry-title_name">美國 Case Naked Tough 雙層防摔手機保護殼 - 絢麗彩虹
		 </h1><p class="price">
		</div></p>
		...
		<form class="cart" method="post" enctype='multipart/form-data'>
			...
			<br>
			<button type="submit" name="add-to-cart" value="26" class="product_entry-add_to_cart">加入購物車</button>
