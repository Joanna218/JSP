...
<head>
	<meta charset="UTF-8">
	<title>I7.8_Air Skin-極致輕薄保護殼</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/42.jpg" alt="smallAir Skin-極致輕薄保護殼">
	  </div>

		<div class="large">
			<img src="../image/i7.8/42.jpg" alt="bigAir Skin-極致輕薄保護殼">
		</div>
		...
		<h1 class="product_entry-title_name">Air Skin-極致輕薄保護殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_Air Skin-極致輕薄保護殼" >
