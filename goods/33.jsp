...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_少女手繪風保護貼+保護套組-愛麗絲(立體彩繪珍珠)</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/33.jpg" alt="small少女手繪風保護貼+保護套組-愛麗絲(立體彩繪珍珠)">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/33.jpg" alt="big少女手繪風保護貼+保護套組-愛麗絲(立體彩繪珍珠)">
		</div>
		...
		<h1 class="product_entry-title_name">少女手繪風保護貼+保護套組-愛麗絲(立體彩繪珍珠)</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I6.6splus_少女手繪風保護貼+保護套組-愛麗絲(立體彩繪珍珠)" >
	 ...
	 <div class="product-details_information">
	 	...
	 	<fieldset>
	 		<legend>商品介紹</legend>
	 		❶少女風不可錯過的閃亮立體材質，視覺觸覺新享受 <br>
	 		❷保護殼採雙料材質製作，防撞、耐刮、裝卸不傷機<br>
	 		❸9H彩繪強化玻璃保護貼，防碎、高透、超輕薄<br>
	 		❹正面、背面一體質感設計，全方位保護你的愛機
	 	</fieldset>
