...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_棉花糖立體軟綿綿動物手機殼(仰頭貓)</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/25.jpg" alt="small棉花糖立體軟綿綿動物手機殼(仰頭貓)">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/25.jpg" alt="big棉花糖立體軟綿綿動物手機殼(仰頭貓)">
		</div>
		...
		<h1 class="product_entry-title_name">棉花糖立體軟綿綿動物手機殼(仰頭貓)</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_棉花糖立體軟綿綿動物手機殼(仰頭貓)" >
