...
<head>
	<meta charset="UTF-8">
	<title>IX_iDeal Of Sweden 瑞典大理石紋手機保護殼-義大利卡拉卡塔海洋金</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/84.jpg" alt="smalliDeal Of Sweden 瑞典大理石紋手機保護殼-義大利卡拉卡塔海洋金">
	  </div>

		<div class="large">
			<img src="../image/iX/84.jpg" alt="bigiDeal Of Sweden 瑞典大理石紋手機保護殼-義大利卡拉卡塔海洋金">
		</div>
		...
		<h1 class="product_entry-title_name">iDeal Of Sweden 瑞典大理石紋手機保護殼-義大利卡拉卡塔海洋金</h1><p class="price">
		</div></p>
			<del><span class=""><span class="Price-currencySymbol">&#78;&#84;&#36;</span>250</span></del> <ins><span class=""><span class="">&#78;&#84;&#36;</span><%=rs.getString("product_price")%></span></ins></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="number" id="quantity_5a3f2f78f12b3" class="input-text qty text" step="1" min="1" max="10000" name="quantity" value="1" title="數量" size="4" pattern="[0-9]*" inputmode="numeric" />
			</div>
			<br>
			<input type="hidden" name="name" value="I7.8plus_iDeal Of Sweden 瑞典大理石紋手機保護殼-義大利卡拉卡塔海洋金" >
