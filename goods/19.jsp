...
<head>
	<meta charset="UTF-8">
	<title>I6.6s_誘惑紅唇印花手機殼 Barracuda Studio設計款</title>
	<!-- demo only -->
...
%>
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6s/19.jpg" alt="small誘惑紅唇印花手機殼 Barracuda Studio設計款">
	  </div>

		<div class="large">
			<img src="../image/i6.6s/19.jpg" alt="big誘惑紅唇印花手機殼 Barracuda Studio設計款">
		</div>
		...
		<h1 class="product_entry-title_name">誘惑紅唇印花手機殼 Barracuda Studio設計款</h1><p class="price">
		</div></p>
