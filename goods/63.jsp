...
<head>
	<meta charset="UTF-8">
	<title>I7.8plus_ESR億色 輕薄磨砂防指紋手機保護殼套</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8plus/63.jpg" alt="smallESR億色 輕薄磨砂防指紋手機保護殼套 ">
	  </div>

		<div class="large">
			<img src="../image/i7.8plus/63.jpg" alt="bigESR億色 輕薄磨砂防指紋手機保護殼套 ">
		</div>
		...
		<h1 class="product_entry-title_name">ESR億色 輕薄磨砂防指紋手機保護殼套</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_ESR億色 輕薄磨砂防指紋手機保護殼套" >
