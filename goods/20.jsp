...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6s/20.jpg" alt="small輕薄保護殼-薄荷綠">
	  </div>

		<div class="large">
			<img src="../image/i6.6s/20.jpg" alt="big輕薄保護殼-薄荷綠">
		</div>
		...
		<h1 class="product_entry-title_name">輕薄保護殼-薄荷綠</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6s_輕薄保護殼-薄荷綠" >
