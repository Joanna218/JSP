...
<head>
	<meta charset="UTF-8">
	<title>IX_UAG 頂級版耐衝擊保護殼-紅金</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/88.jpg" alt="smallUAG 頂級版耐衝擊保護殼-紅金 ">
	  </div>

		<div class="large">
			<img src="../image/iX/88.jpg" alt="bigUAG 頂級版耐衝擊保護殼-紅金">
		</div>
		...
		<h1 class="product_entry-title_name">UAG 頂級版耐衝擊保護殼-紅金</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="IX_UAG 頂級版耐衝擊保護殼-紅金" >
