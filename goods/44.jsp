...
<head>
	<meta charset="UTF-8">
	<title>I7.8_Gramas 日本東京 抗衝擊行李箱-白 </title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/44.jpg" alt="smallGramas 日本東京 抗衝擊行李箱-白">
	  </div>

		<div class="large">
			<img src="../image/i7.8/44.jpg" alt="bigGramas 日本東京 抗衝擊行李箱-白 ">
		</div>
		...
		<h1 class="product_entry-title_name">Gramas 日本東京 抗衝擊行李箱-白 </h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_Gramas 日本東京 抗衝擊行李箱-白" >
