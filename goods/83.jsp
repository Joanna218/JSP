...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/83.jpg" alt="small皮革保護殼">
	  </div>

		<div class="large">
			<img src="../image/iX/83.jpg" alt="big皮革保護殼">
		</div>
		...
		<h1 class="product_entry-title_name">皮革保護殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_皮革保護殼" >
