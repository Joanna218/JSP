...
<head>
	<meta charset="UTF-8">
	<title>I7.8plus_刀鋒奢華 鋁合金+木紋 防摔保護殼</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8plus/70.jpg" alt="small刀鋒奢華 鋁合金+木紋 防摔保護殼">
	  </div>

		<div class="large">
			<img src="../image/i7.8plus/70.jpg" alt="big刀鋒奢華 鋁合金+木紋 防摔保護殼">
		</div>
		...
		<h1 class="product_entry-title_name">刀鋒奢華 鋁合金+木紋 防摔保護殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_刀鋒奢華 鋁合金+木紋 防摔保護殼" >
