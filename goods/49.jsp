...
<head>
	<meta charset="UTF-8">
	<title>I7.8_石墨黑系列高質感側邊防滑手機殼-宇宙火箭</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/49.jpg" alt="small石墨黑系列高質感側邊防滑手機殼-宇宙火箭">
	  </div>

		<div class="large">
			<img src="../image/i7.8/49.jpg" alt="big石墨黑系列高質感側邊防滑手機殼-宇宙火箭">
		</div>
		...
		<h1 class="product_entry-title_name">石墨黑系列高質感側邊防滑手機殼-宇宙火箭</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data'action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_石墨黑系列高質感側邊防滑手機殼-宇宙火箭" >
