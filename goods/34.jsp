...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_優雅色系木紋軟殼 </title>
	<!-- demo only -->
...
%>		
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/34.jpg" alt="small優雅色系木紋軟殼 ">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/34.jpg" alt="big優雅色系木紋軟殼 ">
		</div>
		...
		<h1 class="product_entry-title_name">優雅色系木紋軟殼 </h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I6.6splus_優雅色系木紋軟殼" >
