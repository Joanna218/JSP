...
<head>
	<meta charset="UTF-8">
	<title>I7.8_迪士尼 小熊維尼 金箔 透明硬式手機殼</title>
	<!-- demo only -->
...
%>		
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/55.jpg" alt="small迪士尼 小熊維尼 金箔 透明硬式手機殼">
	  </div>

		<div class="large">
			<img src="../image/i7.8/55.jpg" alt="big迪士尼 小熊維尼 金箔 透明硬式手機殼">
		</div>
		...
		<h1 class="product_entry-title_name">迪士尼 小熊維尼 金箔 透明硬式手機殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data'>
			...
			<br>
			<input type="hidden" name="name" value="I7.8_迪士尼 小熊維尼 金箔 透明硬式手機殼" >
