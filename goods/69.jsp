...
<head>
	<meta charset="UTF-8">
	<title>I7.8plus_UP2度C-英式風兔子</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8plus/69.jpg" alt="smallUP2度C-英式風兔子">
	  </div>

		<div class="large">
			<img src="../image/i7.8plus/69.jpg" alt="bigUP2度C-英式風兔子">
		</div>
		...
		<h1 class="product_entry-title_name">UP2度C-英式風兔子</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_UP2度C-英式風兔子" >
