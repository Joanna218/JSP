...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_WaKase Voyage 城事 - 台北 Taipei - 霧透軟殼</title>
	<!-- demo only -->
...
%>		
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/31.jpg" alt="smallWaKase Voyage 城事 - 台北 Taipei - 霧透軟殼">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/31.jpg" alt="bigWaKase Voyage 城事 - 台北 Taipei - 霧透軟殼">
		</div>
		...
		<h1 class="product_entry-title_name">WaKase Voyage 城事 - 台北 Taipei - 霧透軟殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I6.6splus_WaKase Voyage 城事 - 台北 Taipei - 霧透軟殼" >
