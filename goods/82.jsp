...
<head>
	<meta charset="UTF-8">
	<title>IX_Minions小小兵 空壓安全手機殼(筆記本) 保護殼</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/82.jpg" alt="smallMinions小小兵 空壓安全手機殼(筆記本) 保護殼">
	  </div>

		<div class="large">
			<img src="../image/iX/82.jpg" alt="bigMinions小小兵 空壓安全手機殼(筆記本) 保護殼">
		</div>
		...
		<h1 class="product_entry-title_name">Minions小小兵 空壓安全手機殼(筆記本) 保護殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_kajsa 絨口袋插卡單蓋保護殼-灰" >
