...
<head>
	<meta charset="UTF-8">
	<title>I6.6s_時尚撞色雙層防摔殼-檸檬黃+綠色</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6s/14.jpg" alt="small時尚撞色雙層防摔殼-檸檬黃+綠色">
	  </div>

		<div class="large">
			<img src="../image/i6.6s/14.jpg" alt="big時尚撞色雙層防摔殼-檸檬黃+綠色">
		</div>
		...
		<h1 class="product_entry-title_name">時尚撞色雙層防摔殼-檸檬黃+綠色</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6s_時尚撞色雙層防摔殼-檸檬黃+綠色" >
