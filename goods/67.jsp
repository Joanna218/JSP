...
<head>
	<meta charset="UTF-8">
	<title>I7.8plus_KS防摔鑽殼-星象儀</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8plus/67.jpg" alt="smallKS防摔鑽殼-星象儀">
	  </div>

		<div class="large">
			<img src="../image/i7.8plus/67.jpg" alt="bigKS防摔鑽殼-星象儀">
		</div>
		...
		<h1 class="product_entry-title_name">KS防摔鑽殼-星象儀</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_KS防摔鑽殼-星象儀" >
