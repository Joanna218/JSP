...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_HH 鋼化玻璃手機殼系列  防摔全包覆式(粉紅色)</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/21.jpg" alt="smallHH 鋼化玻璃手機殼系列  防摔全包覆式(粉紅色)">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/21.jpg" alt="bigHH 鋼化玻璃手機殼系列  防摔全包覆式(粉紅色)">
		</div>
		...
		<h1 class="product_entry-title_name">HH 鋼化玻璃手機殼系列  防摔全包覆式(粉紅色)</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_HH 鋼化玻璃手機殼系列  防摔全包覆式(粉紅色)" >
	 ...
	 <div class="product-details_information">
	 	...
	 	<fieldset>
	 		<legend>商品介紹</legend>
	 		❶強化玻璃抗刮表面不易刮傷，LOGO部分也有保護 
	 		<br>
	 		❷背蓋高出鏡頭0.3mm，不怕鏡頭刮傷<br>
	 		❸360度全方面減壓硅膠包覆防護<br>
	 		❹防摔、抗震、耐磨損
	 	</fieldset>
