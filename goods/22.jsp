...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_HH 鋼化玻璃手機殼系列防摔全包覆式(白色)</title>
	<!-- demo only -->
...
%>			
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/22.jpg" alt="smallHH 鋼化玻璃手機殼系列防摔全包覆式(白色)">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/22.jpg" alt="bigHH 鋼化玻璃手機殼系列防摔全包覆式(白色)">
		</div>
		...
		<h1 class="product_entry-title_name">HH 鋼化玻璃手機殼系列防摔全包覆式(白色)</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_HH 鋼化玻璃手機殼系列防摔全包覆式(白色)" >
