...
<head>
	<meta charset="UTF-8">
	<title>I7.8_adidas TPU 彩繪系列手機殼 珊瑚</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/41.jpg" alt="smalladidas TPU 彩繪系列手機殼 珊瑚">
	  </div>

		<div class="large">
			<img src="../image/i7.8/41.jpg" alt="bigadidas TPU 彩繪系列手機殼 珊瑚">
		</div>
		...
		<h1 class="product_entry-title_name">adidas TPU 彩繪系列手機殼 珊瑚</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_adidas TPU 彩繪系列手機殼 珊瑚" >
