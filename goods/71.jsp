...
<head>
	<meta charset="UTF-8">
	<title>I7.8plus_史努比 SNOOPY 漸層彩繪軟式手機殼(跳跳)</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8plus/71.jpg" alt="small史努比 SNOOPY 漸層彩繪軟式手機殼(跳跳)">
	  </div>

		<div class="large">
			<img src="../image/i7.8plus/71.jpg" alt="big史努比 SNOOPY 漸層彩繪軟式手機殼(跳跳)">
		</div>
		...
		<h1 class="product_entry-title_name">史努比 SNOOPY 漸層彩繪軟式手機殼(跳跳)</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_史努比 SNOOPY 漸層彩繪軟式手機殼(跳跳)" >
