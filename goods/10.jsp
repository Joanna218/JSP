...
<head>
	<meta charset="UTF-8">
	<title>I6.6s_迪士尼 復古胡迪 皮革系列</title>
	<!-- demo only -->
...
%>
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6s/10.jpg" alt="small迪士尼 復古胡迪 皮革系列">
	  </div>

		<div class="large">
			<img src="../image/i6.6s/10.jpg" alt="big迪士尼 復古胡迪 皮革系列">
		</div>
		...
		<h1 class="product_entry-title_name">迪士尼 復古胡迪 皮革系列</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6s_迪士尼 復古胡迪 皮革系列" >
