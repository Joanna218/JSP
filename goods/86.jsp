...
<head>
	<meta charset="UTF-8">
	<title>IX_OtterBox 通勤者系列保護殼-淺綠</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/86.jpg" alt="smallOtterBox 通勤者系列保護殼-淺綠 ">
	  </div>

		<div class="large">
			<img src="../image/iX/86.jpg" alt="bigOtterBox 通勤者系列保護殼-淺綠 ">
		</div>
		...
		<h1 class="product_entry-title_name">OtterBox 通勤者系列保護殼-淺綠 </h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_OtterBox 通勤者系列保護殼-淺綠" >
