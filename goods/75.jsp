...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8plus/75.jpg" alt="small泡泡保護套 - 貓熊">
	  </div>

		<div class="large">
			<img src="../image/i7.8plus/75.jpg" alt="big泡泡保護套 - 貓熊">
		</div>
		...
		<h1 class="product_entry-title_name">泡泡保護套 - 貓熊</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8plus_泡泡保護套 - 貓熊" >
