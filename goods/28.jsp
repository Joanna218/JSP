...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_Nexestek 類皮革款手機保護殼</title>
	<!-- demo only -->
			...
			<ul class="drop-down-menu">
        		...
        		<li><a href="../member..jsp">會員中心</a>
            		<ul>
                		...
                		<li><a href="mbinfornation.jsp">修改資料</a>
                		</li>
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/28.jpg" alt="smallNexestek 類皮革款手機保護殼">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/28.jpg" alt="bigNexestek 類皮革款手機保護殼">
		</div>
		...
		<h1 class="product_entry-title_name">Nexestek 類皮革款手機保護殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="post" enctype='multipart/form-data' action="../addcar.jsp">
			<div class="quantity">
			...
			<input type="hidden" name="name" value="I6.6splus_Nexestek 類皮革款手機保護殼" >
	 ...
	 <div class="product-details_information">
	 	...
	 	<fieldset>
	 		...
	 		❶適合個性風的您  
	 		<br>
	 		❷超合身設計,提供您軟硬兼具的保護力 <br>
	 		❸所有孔位均可使用,不須任何工具,不影響日常使用功能<br>
	 	</fieldset>
