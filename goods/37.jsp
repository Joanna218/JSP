...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_氣墊空壓漸變保護套</title>
	<!-- demo only -->
...
%>		
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/37.jpg" alt="small氣墊空壓漸變保護套">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/37.jpg" alt="big氣墊空壓漸變保護套">
		</div>
		...
		<h1 class="product_entry-title_name">氣墊空壓漸變保護套</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_氣墊空壓漸變保護套" >
