...
<head>
	<meta charset="UTF-8">
	<title>I7.8_英倫風絨布拼接撞色 可插卡 手機殼</title>
	<!-- demo only -->
...
%>		
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/53.jpg" alt="small英倫風絨布拼接撞色 可插卡 手機殼">
	  </div>

		<div class="large">
			<img src="../image/i7.8/53.jpg" alt="big英倫風絨布拼接撞色 可插卡 手機殼">
		</div>
		...
		<h1 class="product_entry-title_name">英倫風絨布拼接撞色 可插卡 手機殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_英倫風絨布拼接撞色 可插卡 手機殼" >//這
