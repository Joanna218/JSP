...
<head>
	<meta charset="UTF-8">
	<title>IX_美國 Case Naked Tough 雙層防摔手機保護殼 - 透明 </title>
	<!-- demo only -->
...
<body>
	...
	<!--index-->
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/93.jpg" alt="small美國 Case Naked Tough 雙層防摔手機保護殼 - 透明
			  ">
	  </div>

		<div class="large">
			<img src="../image/iX/93.jpg" alt="big美國 Case Naked Tough 雙層防摔手機保護殼 - 透明
			">
		</div>
		...
		<h1 class="product_entry-title_name">美國 Case Naked Tough 雙層防摔手機保護殼 - 透明
		 </h1><p class="price">
		</div></p>
