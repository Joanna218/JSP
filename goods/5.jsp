...
%>			
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6s/05.jpg" alt="small全包覆-流沙灰 手機殼">
	  </div>

		<div class="large">
			<img src="../image/i6.6s/05.jpg" alt="big全包覆-流沙灰 手機殼">
		</div>
		...
		<h1 class="product_entry-title_name">全包覆-流沙灰 手機殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6s_全包覆-流沙灰 手機殼" >
