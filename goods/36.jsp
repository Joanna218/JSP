...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_凌度系列 拆卸式透明手機殼 手機套 金</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/36.jpg" alt="small凌度系列 拆卸式透明手機殼 手機套 金">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/36.jpg" alt="big凌度系列 拆卸式透明手機殼 手機套 金">
		</div>
		...
		<h1 class="product_entry-title_name">凌度系列 拆卸式透明手機殼 手機套 金</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_凌度系列 拆卸式透明手機殼 手機套 金" >
