...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_搖滾巨星印花手機殼 Seohwa Kim設計款</title>
	<!-- demo only -->
...
//Step 4: 執行 SQL 指令	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/38.jpg" alt="small搖滾巨星印花手機殼 Seohwa Kim設計款">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/38.jpg" alt="big搖滾巨星印花手機殼 Seohwa Kim設計款">
		</div>
		...
		<h1 class="product_entry-title_name">搖滾巨星印花手機殼 Seohwa Kim設計款</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_搖滾巨星印花手機殼 Seohwa Kim設計款" >
