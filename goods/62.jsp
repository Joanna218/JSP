...
<head>
	<meta charset="UTF-8">
	<title>I7.8plus_Baseus倍思 簡約皮套 滑動接聽 支架手機殼 保護套</title>
	<!-- demo only -->
...
%>		
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8plus/62.jpg" alt="smallBaseus倍思 簡約皮套 滑動接聽 支架手機殼 保護套 ">
	  </div>

		<div class="large">
			<img src="../image/i7.8plus/62.jpg" alt="bigBaseus倍思 簡約皮套 滑動接聽 支架手機殼 保護套 ">
		</div>
		...
		<h1 class="product_entry-title_name">Baseus倍思 簡約皮套 滑動接聽 支架手機殼 保護套</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_Baseus倍思 簡約皮套 滑動接聽 支架手機殼 保護套" >
