...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_LINE FRIENDS 透明硬式保護殼-綁架熊大</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/26.jpg" alt="smallLINE FRIENDS 透明硬式保護殼-綁架熊大">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/26.jpg" alt="bigLINE FRIENDS 透明硬式保護殼-綁架熊大">
		</div>
		...
		<h1 class="product_entry-title_name">LINE FRIENDS 透明硬式保護殼-綁架熊大</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_LINE FRIENDS 透明硬式保護殼-綁架熊大" >
