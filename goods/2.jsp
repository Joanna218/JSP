...
<head>
	<meta charset="UTF-8">
	<title>I6.6s_X'mas 冬戀樂章-霧黑雪花 手機殼</title>
	<!-- demo only -->
...
%>		
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6s/02.jpg" alt="smallX'mas 冬戀樂章-霧黑雪花 手機殼">
	  </div>

		<div class="large">
			<img src="../image/i6.6s/02.jpg" alt="bigX'mas 冬戀樂章-霧黑雪花 手機殼">
		</div>
		...
		<h1 class="product_entry-title_name">X'mas 冬戀樂章-霧黑雪花 手機殼</h1><p class="price">
		</div></p>
			<del><span class=""><span class="Price-currencySymbol">&#78;&#84;&#36;</span>20</span></del> <ins><span class=""><span class="">&#78;&#84;&#36;</span><%=rs.getString("product_price")%></span></ins></p>
			<br>
		</div>
		...
		<form class="cart" method="GET" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I6.6s_Xmass " >
