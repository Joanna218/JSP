...
<head>
	<meta charset="UTF-8">
	<title>IX_拉拉熊 Rilakkuma 變裝系列彩繪手機殼(狐狸黃)</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/90.jpg" alt="small拉拉熊 Rilakkuma 變裝系列彩繪手機殼(狐狸黃) ">
	  </div>

		<div class="large">
			<img src="../image/iX/90.jpg" alt="big拉拉熊 Rilakkuma 變裝系列彩繪手機殼(狐狸黃)">
		</div>
		...
		<h1 class="product_entry-title_name">拉拉熊 Rilakkuma 變裝系列彩繪手機殼(狐狸黃)</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="IX_拉拉熊 Rilakkuma 變裝系列彩繪手機殼(狐狸黃)" >
