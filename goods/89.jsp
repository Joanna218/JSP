...
<head>
	<meta charset="UTF-8">
	<title>IX_史努比 SNOOPY 漸層彩繪軟式手機殼(紙飛機)</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/iX/89.jpg" alt="small史努比 SNOOPY 漸層彩繪軟式手機殼(紙飛機) ">
	  </div>

		<div class="large">
			<img src="../image/iX/89.jpg" alt="big史努比 SNOOPY 漸層彩繪軟式手機殼(紙飛機)">
		</div>
		...
		<h1 class="product_entry-title_name">史努比 SNOOPY 漸層彩繪軟式手機殼(紙飛機)</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="IX_史努比 SNOOPY 漸層彩繪軟式手機殼(紙飛機)" >
