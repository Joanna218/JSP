...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6s/17.jpg" alt="small斯文法鬥 i6軟殼">
	  </div>

		<div class="large">
			<img src="../image/i6.6s/17.jpg" alt="big斯文法鬥 i6軟殼">
		</div>
		...
		<h1 class="product_entry-title_name">斯文法鬥 i6軟殼</h1><p class="price">
		</div></p>
	 ...
	 <div class="product-details_information">
	 	...
	 	<fieldset>
	 		<legend>商品介紹</legend>
	 		❶專為iPhone6量身打造 密合度高斯文法鬥 i6軟殼<br>
