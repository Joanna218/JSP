...
<head>
	<meta charset="UTF-8">
	<title>I7.8_NILLKIN 卡仕商務手機殼 三色</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i7.8/46.jpg" alt="smallNILLKIN 卡仕商務手機殼 三色">
	  </div>

		<div class="large">
			<img src="../image/i7.8/46.jpg" alt="bigNILLKIN 卡仕商務手機殼 三色">
		</div>
		...
		<h1 class="product_entry-title_name">NILLKIN 卡仕商務手機殼 三色</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<br>
			<input type="hidden" name="name" value="I7.8_NILLKIN 卡仕商務手機殼 三色" >
