...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6s/12.jpg" alt="small原木防摔-橘 手機殼">
	  </div>

		<div class="large">
			<img src="../image/i6.6s/12.jpg" alt="big原木防摔-橘 手機殼">
		</div>
		...
		<h1 class="product_entry-title_name">原木防摔-橘 手機殼</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6s_原木防摔-橘 手機殼" >
