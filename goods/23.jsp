...
<head>
	<meta charset="UTF-8">
	<title>I6.6splus_HOCAR 爵士皮革保護手機殼 背蓋(暗紅)</title>
	<!-- demo only -->
...
%>	
	 ...
	 <div class="columns-3">
		...
		<div class="small">
			<img src="../image/i6.6splus/23.jpg" alt="smallHOCAR 爵士皮革保護手機殼 背蓋(暗紅)">
	  </div>

		<div class="large">
			<img src="../image/i6.6splus/23.jpg" alt="bigHOCAR 爵士皮革保護手機殼 背蓋(暗紅)">
		</div>
		...
		<h1 class="product_entry-title_name">HOCAR 爵士皮革保護手機殼 背蓋(暗紅)</h1><p class="price">
		</div></p>
		...
		<form class="cart" method="get" enctype='multipart/form-data' action="../addcar.jsp">
			...
			<input type="hidden" name="name" value="I6.6splus_HOCAR 爵士皮革保護手機殼 背蓋(暗紅)" >
