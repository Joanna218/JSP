  ...
  <div class='wrapper'>
    ...
    <div class='right_content'>
      ...
      <%
       //抓取更新的欄位，第一次執行為null
        ...
        if("delete".equals(modify)) {
          sql="DELETE FROM book WHERE no = '"+input_no+"' ";
      ...
      <%
        ...
        int n =1;
        while(rs.next()) {
          out.print("<tr><form action='order.jsp' method='post'>");
          //out.print("印n :"+n);
          ...
          out.print("<td><input type='text' name='up_quantity' size='10' value="+rs.getString("quantity")+"></td>");
          //out.print("<td><input type='text' name='up_price' size='15' value="+rs.getString("price")+"></td>");
          out.print("<td><input type='text' name='up_totalprice'  value="+rs.getString("new_totalprice")+"></td>");
