  ...
  <div class='wrapper'>
    ...
    <div class='right_content'>
      ...
      <div style="margin:20px;padding:20px;">
        <form action="search_pi78p_update.jsp" method="POST">
      ...
      <table class='table_member'>
        <form action='product_i78pupdate.jsp' method='post'>
          <tr>
            <td>圖片</td>
            <td>名稱</td>
            <td>價格</td>
      ...
      <%
        ...
        if("delete".equals(modify)) {
          //out.print("有近來");
          sql="DELETE FROM i78p WHERE product_no = '"+input_no+"' ";
				  con.createStatement().execute(sql);
          //刪除product資料表
          sql="DELETE FROM product WHERE product_name = '"+input_name+"' ";
          con.createStatement().execute(sql);
        } else if ("update".equals(modify)) {
          sql="UPDATE i78p SET product_name= '"+input_name+"',product_price = '"+input_price+"' ,product_num = '"+input_num+"',YN = '"+cb_YN+"'WHERE product_no = '"+input_no+"'";
          out.print(sql);
        ...
        if("add".equals(modify)) {
          ...
          sql = "insert i78p (image_path, product_name, product_price, product_num,YN) VALUES(?, ? ,?,?,?)";
        ...
        int n=1;
        while(rs.next()) {
          out.print("<tr><form action='product_i78pupdate.jsp' method='POST'>");
          //out.print("印n :"+n);
