  ...
  <div class='wrapper'>
    ...
    <header class='header'>
      ...
      <%-- joanna --%>
        <%
          ...
          if(Back_ID!=null){
		        out.print("<span><a href='#'>"+Back_ID+"</a></span><span><a href='logout.jsp'>登出</a></span>");
          }
        %>
      </div>
    </header>
    ...
    <div class='right_content'>
      ...
      <%
        ...
        sql = "SELECT  product_no,image_path, product_name, product_price, product_num, YN FROM ix WHERE product_name LIKE '%"+search+"%' ";
